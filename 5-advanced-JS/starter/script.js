...
// var mary = new Person('Mary', 1984, 'designer');
...
//     } else {
//         return function(name) {
//             console.log('Hello ' + name + ', what job do you do?');
//         }
//     }
// }
...
// var interviewDriver = interviewQuestion('driver');

// interviewTeacher('John');
// interviewDesigner('John');
// interviewDriver('John');
...
//     var q1 = new Question('What planet do we live on?', ['Earth', 'Moon', 'Jupiter'], 0);
//     var q2 = new Question('What color is the sky?', ['Red', 'Purple', 'Blue'], 2);
//     var q3 = new Question('What is the population of planet Earth?', ['5.3 Billion', '7.5 Billion', '9.7 Billion'], 1);
